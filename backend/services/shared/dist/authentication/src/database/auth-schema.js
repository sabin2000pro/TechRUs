...
var AUTH_SERVICE_DB_URI = process.env.AUTH_SERVICE_DB_URI;
var connectAuthDatabase = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1.default.connect(AUTH_SERVICE_DB_URI).then(function (authConnection) {
