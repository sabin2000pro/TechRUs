...
var SHIPPING_SERVICE_DB_URI = process.env.SHIPPING_SERVICE_DB_URI || 5411;
var connectShippingSchema = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, mongoose_1.default.connect(SHIPPING_SERVICE_DB_URI).then(function (conn) {
                        if (conn.connection) {
